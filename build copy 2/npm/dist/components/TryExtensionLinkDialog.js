...
var _globeIconSvg = _interopRequireDefault(require("./icons/globe-icon-svg"));

var _linkIconSvg = _interopRequireDefault(require("./icons/link-icon-svg"));

var _lockIconSvg = _interopRequireDefault(require("./icons/lock-icon-svg"));

var _QRLogo = _interopRequireDefault(require("./icons/QRLogo"));

var _QRCode = require("./QRCode");

var _Spinner = require("./Spinner");

var _TryExtensionLinkDialogCss = _interopRequireDefault(require("./TryExtensionLinkDialog-css"));
...
const TryExtensionLinkDialog = props => {
  ...
  return h("div", {
    class: (0, _clsx.default)("-cbwsdk-extension-dialog-container", isContainerHidden && "-cbwsdk-extension-dialog-container-hidden")
  }, h("style", null, _TryExtensionLinkDialogCss.default), h("div", {
    class: (0, _clsx.default)("-cbwsdk-extension-dialog-backdrop", isDialogHidden && "-cbwsdk-extension-dialog-backdrop-hidden")
  }), h("div", {
    class: "-cbwsdk-extension-dialog"
  }, h("div", {
    class: (0, _clsx.default)("-cbwsdk-extension-dialog-box", isDialogHidden && "-cbwsdk-extension-dialog-box-hidden")
  }, h(TryExtensionBox, {
    onInstallClick: () => {
      window.open("https://api.wallet.coinbase.com/rpc/v2/desktop/chrome", "_blank");
    }
  }), !props.connectDisabled ? h(ScanQRBox, {
  ...
  }) : null, props.onCancel && h(CancelButton, {
...
const TryExtensionBox = ({
  onInstallClick
}) => {
  const [isClicked, setIsClicked] = (0, _hooks.useState)(false);
  const clickHandler = (0, _hooks.useCallback)(() => {
    if (isClicked) {
  ...
  }, h("h2", null, "Try the Coinbase Wallet extension"), isClicked && h("div", {
    class: "-cbwsdk-extension-dialog-box-top-subtext"
  }, "After installing Coinbase Wallet, refresh the page and connect again."), h("button", {
    type: "button",
    onClick: clickHandler
  }, isClicked ? "Refresh" : "Install")), h("div", {
    class: "-cbwsdk-extension-dialog-box-top-info-region"
  }, h(DescriptionItem, {
    icon: _linkIconSvg.default,
    text: "Connect to crypto apps with one click"
  }), h(DescriptionItem, {
    icon: _lockIconSvg.default,
    text: "Your private key is stored securely"
  }), h(DescriptionItem, {
    icon: _globeIconSvg.default,
...
const ScanQRBox = props => {
  ...
  return h("div", {
    class: "-cbwsdk-extension-dialog-box-bottom"
  }, h("div", {
    class: "-cbwsdk-extension-dialog-box-bottom-description-region"
  }, h("h2", null, "Or scan to connect"), h("body", {
    class: "-cbwsdk-extension-dialog-box-bottom-description"
  }, "Open", " ", h("a", {
    href: "https://wallet.coinbase.com/",
    target: "_blank",
    rel: "noopener noreferrer"
  }, "Coinbase Wallet"), " ", "on your mobile phone and scan")), h("div", {
...
const DescriptionItem = props => {
  return h("div", {
    ...
    class: "-cbwsdk-extension-dialog-box-top-description-text"
  }, props.text));
};
...
const CancelButton = props => h("button", {
  ...
  class: "-cbwsdk-extension-dialog-box-cancel-x"
}));