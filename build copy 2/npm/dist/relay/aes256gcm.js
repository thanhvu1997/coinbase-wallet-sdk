...
async function encrypt(plainText, secret) {
  ...
  const secretKey = await crypto.subtle.importKey("raw", (0, _util.hexStringToUint8Array)(secret), {
    name: "aes-gcm"
  ...
  return (0, _util.uint8ArrayToHex)(concatted);
}
/**
 *
...
function decrypt(cipherText, secret) {
  ...
  return new _rxjs.Observable(subscriber => {
    void async function () {
      ...
      const encrypted = (0, _util.hexStringToUint8Array)(cipherText);
