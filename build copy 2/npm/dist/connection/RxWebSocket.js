...
class RxWebSocket {
  ...
  constructor(url, WebSocketClass = WebSocket) {
    ...
    _defineProperty(this, "connectionStateSubject", new _rxjs.BehaviorSubject(ConnectionState.DISCONNECTED));

    _defineProperty(this, "incomingDataSubject", new _rxjs.Subject());
  ...
  connect() {
    if (this.webSocket) {
      return (0, _rxjs.throwError)(new Error("webSocket object is not null"));
    }
  ...
  get incomingJSONData$() {
    return this.incomingData$.pipe((0, _operators.flatMap)(m => {
      let j;
